  ...
  return (
    <Grid2 container className="justify-center">
      ...
      <Typography variant="subtitle1">
        The Khanjahan Ali Rahmatullah Jame Masjid is a Sunni mosque located in
        Khulna, Khulna. Established in 1980, it has been serving the local
        community for several decades. This mosque is known for its beautiful
        ...
        Whether you are seeking a place for prayer or simply want to experience
        the peaceful ambiance, the Khanjahan Ali Rahmatullah Jame Masjid is a
        welcoming mosque in Khulna, Khulna.
      </Typography>
    </Grid2>
  );
}
